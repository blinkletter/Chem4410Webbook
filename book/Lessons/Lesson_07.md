# Lesson 7: Pericyclic Reactions

In this lesson, we will examine some literature **examples** that I have selected featuring mechansims that are controlled by molecular orbital interactions. These examples align with **chapter 15** of the textbook. Over the two weeks of this lesson you should read all of chapter 15, not just the tiny bits we are picking for these examples.
...
Keep working on your own **personal exploration**. Your final version will be due during this lessson.
