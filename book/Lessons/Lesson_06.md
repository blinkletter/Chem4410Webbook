# Lesson 6: Addition \& Elimination Reactions

We now continue the **second phase** of the course: exploring ideas in physical organic chemistry.  We will examine some literature **examples** that I have selected featuring **addition and elimination** mechanisms. These examples align with **chapter 10** of the textbook. Over the two weeks of this lesson you should read all of chapter 10, not just the tiny bits we are picking for these examples.
...
Along the way, keep looking for a **topic** that you would like to **explore** more deeply on your own. You **personal exploration** will be an important part of this second phase of the course.

## Lesson Schedule

This lesson will take place over **six class meetings**. We will explore a variety of examples of mechanistic investigations and heroic synthetic chemistry.
